...
#set -e
echo "input command:train or eval or vis or export:"
read a
echo "input is $a"
...
PASCAL_FOLDER="battery_seg"
EXP_FOLDER="exp_mobilenetv2/train_on_trainval_set"
INIT_FOLDER="${WORK_DIR}/${DATASET_DIR}/${PASCAL_FOLDER}/init_models"
TRAIN_LOGDIR="${WORK_DIR}/${DATASET_DIR}/${PASCAL_FOLDER}/${EXP_FOLDER}/train1"
