...
_BATTERY_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 1464,
        'trainval': 2913,
        'val': 1449,
...
_BATTERY_WORD_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 117,
        'trainval': 131,
        'val': 14,
...
_DATASETS_INFORMATION = {
    ...
    'battery':_BATTERY_SEG_INFORMATION,
    'battery_word':_BATTERY_WORD_SEG_INFORMATION
}
